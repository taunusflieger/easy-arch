...
pacstrap /mnt base "$kernel" "$microcode" linux-firmware "$kernel"-headers btrfs-progs grub grub-btrfs rsync efibootmgr snapper reflector zram-generator mlocate neovim openssh pacman-contrib pkgfile reflector sudo terminus-font
