...
for subvol in '' "${subvols[@]}"; do
    info_print "Creating subvolume $subvol"
...
for subvol in "${subvols[@]:2}"; do
    info_print "Mounting subvolume $subvol"
...
pacstrap /mnt base "$kernel" "$microcode" linux-firmware "$kernel"-headers btrfs-progs grub grub-btrfs rsync efibootmgr snapper reflector snap-pac zram-generator mlocate neovim nopenssh pacman-contrib pkgfile reflector sudo terminus-font
